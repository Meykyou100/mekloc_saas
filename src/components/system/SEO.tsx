      ...
      offers: [
        {
          '@type': 'Offer',
          name: 'Starter',
          price: MEKLOC_PLANS.starter.packagePrice,
          priceCurrency: 'MAD',
          category: '6-month subscription',
        },
        {
          '@type': 'Offer',
          name: 'Pro',
          price: MEKLOC_PLANS.pro.packagePrice,
          priceCurrency: 'MAD',
        ...
        },
        {
          '@type': 'Offer',
          name: 'Business',
          price: MEKLOC_PLANS.business.packagePrice,
          priceCurrency: 'MAD',
          category: 'annual subscription',
        },
        {
          '@type': 'Offer',
          name: 'Lifetime',
          price: MEKLOC_PLANS.lifetime.lifetimePrice,
          priceCurrency: 'MAD',
