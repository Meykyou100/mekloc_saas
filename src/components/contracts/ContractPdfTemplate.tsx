    ...
    <div className={`rc-brand${compact ? ' rc-brand-compact' : ''}`}>
      {agency.logoUrl && !logoBroken ? (
        <img
          ...
          className={`rc-brand-logo${compact ? ' rc-brand-logo-compact' : ''}`}
          style={compact
            ? { maxWidth: `${logoWidth}px`, maxHeight: `${logoHeight}px` }
  ...
  return (
    <div className={`contract-pdf-template ${className}`}>
      <style>{`
        ...
        .rc-page-one { padding: 9px 32px 24px 56px; }
        .rc-top {
          display: grid;
        ...
        .rc-header-cars { height: 171px; overflow: hidden; }
        .rc-header-cars img {
          display: block;
          width: 100%;
          height: 100%;
        ...
        <div className="rc-vehicle-area">
          <div>
            <div className="rc-rounded-box">
              <div className="rc-inline-2 rc-vehicle-primary-row">
