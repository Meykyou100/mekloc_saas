  ...
  return (
    <div className="relative grid min-h-screen place-items-center overflow-hidden bg-[#060708] px-5 py-[max(2rem,env(safe-area-inset-top))] text-white">
      <style>{`
        ...
        @keyframes mekloc-loader-ring { to { transform: rotate(360deg); } }
        ...
        .mekloc-loader-ring { animation: mekloc-loader-ring 7s linear infinite; }
        ...
        @media (prefers-reduced-motion: reduce) { .mekloc-loader-card, .mekloc-loader-ring, .mekloc-loader-shimmer, .mekloc-loader-dot { animation: none; } }
      `}</style>
      ...
      <div className="mekloc-loader-card relative w-full max-w-[440px] rounded-[30px] border border-gold-300/25 bg-[#0d0f11] p-7 shadow-[0_26px_80px_rgba(0,0,0,.48),0_0_42px_rgba(227,177,23,.08)] sm:p-9" role="status" aria-live="polite">
        <div className="mx-auto grid h-[82px] w-[82px] place-items-center rounded-[26px] border border-gold-300/25 bg-gold-400/[0.08]">
          <span className="mekloc-loader-ring absolute h-[92px] w-[92px] rounded-[30px] border border-transparent border-t-gold-300/65 border-r-gold-300/20" />
