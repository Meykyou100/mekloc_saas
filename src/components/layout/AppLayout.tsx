  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-carbon-950 text-white light:bg-carbon-50 light:text-carbon-950">
      ...
      <div className="min-h-screen lg:pl-72">
        ...
        <main className="relative px-4 pb-[calc(7rem+env(safe-area-inset-bottom))] pt-5 sm:px-6 lg:px-8 lg:pb-10">
          <div
      ...
      <nav className="fixed inset-x-3 bottom-3 z-40 rounded-[24px] border border-white/10 bg-black/82 px-2 pb-[max(env(safe-area-inset-bottom),0.45rem)] pt-1.5 shadow-[0_0_42px_rgba(0,0,0,.52),inset_0_1px_0_rgba(255,255,255,.06)] backdrop-blur-2xl lg:hidden">
        <div className="grid grid-cols-6 items-center gap-1">
          {[
            ...
            <NavLink key={to} to={to} className={({ isActive }) => `flex min-h-[58px] flex-col items-center justify-center gap-1 rounded-2xl px-1 py-2 text-center text-[10px] font-bold transition ${isActive ? 'bg-[#D4A017]/12 text-gold-100 shadow-[inset_0_0_0_1px_rgba(212,160,23,.22)]' : 'text-carbon-400 hover:text-white'}`}>
