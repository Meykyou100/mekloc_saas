...
export const MEKLOC_PLANS = {
  starter: {
    ...
    packagePrice: 2394,
    packageLabel: '/ 6 mois',
    equivalentLabel: 'équivalent 399 MAD / mois',
    billingTotal: 2394,
    lifetimePrice: 0,
  ...
  pro: {
    ...
    packagePrice: 3588,
    packageLabel: '/ an',
    equivalentLabel: 'équivalent 299 MAD / mois',
    billingTotal: 3588,
    lifetimePrice: 0,
  ...
  business: {
    ...
    packagePrice: 5988,
    packageLabel: '/ an',
    equivalentLabel: 'équivalent 499 MAD / mois',
    billingTotal: 5988,
    lifetimePrice: 0,
    billingChoice: 'annual',
  ...
  lifetime: {
    ...
    annualPrice: 9999,
    packagePrice: 9999,
    packageLabel: 'paiement unique',
    equivalentLabel: 'accès à vie',
    billingTotal: 9999,
    lifetimePrice: 9999,
