  ...
  return (
    <div>
      ...
      <div className="mb-5 grid grid-cols-2 gap-2 sm:gap-3 sm:grid-cols-2 xl:grid-cols-5">
        <Card className="min-h-[104px] bg-gradient-to-br from-zinc-950/95 to-black/70 p-3.5 sm:p-4"><p className="line-clamp-2 text-[10px] font-semibold uppercase tracking-[0.08em] text-carbon-500 sm:text-xs">Total</p><p className="mt-2 truncate text-xl font-black sm:text-2xl">{stats.total}</p></Card>
        <Card className="min-h-[104px] bg-gradient-to-br from-zinc-950/95 to-black/70 p-3.5 sm:p-4"><p className="line-clamp-2 text-[10px] font-semibold uppercase tracking-[0.08em] text-carbon-500 sm:text-xs">Disponibles</p><p className="mt-2 truncate text-xl font-black text-emerald-300 sm:text-2xl">{stats.available}</p></Card>
        <Card className="min-h-[104px] bg-gradient-to-br from-zinc-950/95 to-black/70 p-3.5 sm:p-4"><p className="line-clamp-2 text-[10px] font-semibold uppercase tracking-[0.08em] text-carbon-500 sm:text-xs">Loués</p><p className="mt-2 truncate text-xl font-black text-sky-300 sm:text-2xl">{stats.rented}</p></Card>
        <Card className="min-h-[104px] bg-gradient-to-br from-zinc-950/95 to-black/70 p-3.5 sm:p-4"><p className="line-clamp-2 text-[10px] font-semibold uppercase tracking-[0.08em] text-carbon-500 sm:text-xs">Maintenance / indispo</p><p className="mt-2 truncate text-xl font-black text-amber-300 sm:text-2xl">{stats.maintenance}</p></Card>
        <Card className="min-h-[104px] bg-gradient-to-br from-zinc-950/95 to-black/70 p-3.5 sm:p-4"><p className="line-clamp-2 text-[10px] font-semibold uppercase tracking-[0.08em] text-carbon-500 sm:text-xs">Prix moyen / jour</p><p className="mt-2 truncate text-xl font-black text-gold-200 sm:text-2xl">{formatMAD(stats.avgPrice)}</p><p className="mt-1 text-[10px] text-carbon-500">Archivés: {stats.archived}</p></Card>
      </div>
