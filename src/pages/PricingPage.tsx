...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,rgba(227,177,23,.13),transparent_30%),#050606] px-4 py-6 text-white light:bg-[radial-gradient(circle_at_50%_0%,rgba(227,177,23,.12),transparent_30%),#f8f5ed] light:text-carbon-950 sm:px-6 sm:py-10 lg:px-8">
      <SEO
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto mt-10 max-w-3xl text-center sm:mt-14">
          <p className="text-xs font-black uppercase tracking-[0.28em] text-gold-300">Plans & abonnement</p>
          <h1 className="mt-3 text-4xl font-black tracking-tight text-white light:text-carbon-950 sm:text-5xl">Tarifs MekLoc</h1>
          <p className="mt-3 text-base leading-7 text-carbon-300 light:text-carbon-600">
            Tous les plans incluent 7 jours d’essai gratuit. Choisissez une durée claire selon votre agence.
          </p>
          <p className="mt-3 text-sm font-black text-gold-300">Engagement minimum : 6 mois</p>
        </div>
        <div className="mx-auto mt-8 flex w-fit max-w-full gap-1 overflow-x-auto rounded-2xl border border-white/10 bg-black/35 p-1.5 shadow-[0_12px_30px_rgba(0,0,0,.22)] light:border-carbon-200 light:bg-white light:shadow-[0_10px_25px_rgba(68,52,20,.08)]">
        ...
        <div className={`mt-10 grid items-stretch gap-5 ${billingChoice === 'lifetime' ? 'mx-auto max-w-lg' : 'md:grid-cols-2 xl:grid-cols-3'}`}>
          {offers.map((offer) => {
            ...
            <Card
              ...
              className={`relative flex min-h-full flex-col overflow-hidden rounded-[28px] border p-5 shadow-[0_20px_55px_rgba(0,0,0,.22)] sm:p-6 ${featured ? 'border-gold-300/50 bg-[linear-gradient(155deg,rgba(227,177,23,.15),rgba(15,16,18,.96)_28%,rgba(6,7,8,1))] shadow-[0_20px_65px_rgba(227,177,23,.12)]' : 'border-white/10 bg-[linear-gradient(155deg,rgba(255,255,255,.055),rgba(15,16,18,.96)_28%,rgba(6,7,8,1))]'} light:bg-white`}
            >
              ...
              <div className="mt-5 border-y border-white/10 py-4 light:border-carbon-100"><p className="text-4xl font-black tracking-tight text-white light:text-carbon-950">
                {price}
              ...
              <a
                ...
                className={`mt-6 flex h-12 w-full items-center justify-center rounded-2xl border text-sm font-black transition duration-300 hover:-translate-y-0.5 active:translate-y-0 ${
                  featured
        ...
        <p className="mt-8 text-center text-sm font-semibold text-carbon-300 light:text-carbon-600">Tous les plans incluent 7 jours d’essai gratuit.</p>
      </div>
    </div>
  );
}
