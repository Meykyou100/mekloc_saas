...
export const plans = [
  {
    ...
    features: ['Jusqu’à 7 véhicules', 'Réservations', 'Clients', 'Contrats PDF', 'Paiements & cautions', 'Entretien essentiel', 'Support standard'],
  },
  {
    id: 'business',
    name: 'Business',
    ...
    featured: true,
    badge: 'Recommandé',
    features: ['Jusqu’à 20 véhicules', 'Réservations illimitées', 'Clients illimités', 'Contrats PDF illimités', 'Paiements & factures', 'Entretien avancé', 'Alertes', 'Rapports', 'Support prioritaire'],
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    featured: true,
    badge: 'Illimité',
    features: ['Véhicules illimités', 'Toutes les fonctionnalités Business', 'Équipe multi-utilisateurs', 'Rapports avancés', 'Automatisations', 'Support prioritaire'],
  },
  {
    id: 'lifetime',
    name: 'Lifetime',
